...
const int NUM_POKEMON = 151; //Number of pokemon in total
const int ATTACK_VALUE = 1; //Value that the user chooses to attack
const int SWAP_VALUE = 2; //Value that the user chooses to swap
const int FORFEIT_VALUE = 3; //Value that the user chooses to forfeit
